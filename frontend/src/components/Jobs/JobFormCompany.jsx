...
export default function JobFormCompany({ job, companies, selectedCompany, onChange, onChangeCompany, onGoToTeam }) {
    ...
    <div className="space-y-3">
      <div>
        ...
        <div className="flex items-center gap-2 bg-slate-50 border border-slate-200 rounded-xl px-2.5 focus-within:border-emerald-500 focus-within:bg-white transition">
          ...
          <select required value={job.company_id} onChange={(e) => onChangeCompany(e.target.value)}
